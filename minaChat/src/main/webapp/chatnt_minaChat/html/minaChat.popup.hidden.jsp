...
<template:addResources type="css" resources="le-frog/jquery-ui-1.8.13.custom.css,minachat.css"/>
    ...
    <c:choose>
        ...
        <c:otherwise>
            ...
            <table>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><input type="button" id="connect" value="Connect" style="float: right; margin-top: 5px;" /></td>
                </tr>
            </table>
            </div>
        </c:otherwise>
...
<div id="buttons" style="border: 1px solid; overflow: auto; float: left;">
<input type="button" id="addcontact" value="addcontact" style="float: right; margin-top: 5px;" />
<input type="button" id="disconnect" value="disconnect" style="float: right; margin-top: 5px;" />
<input type="button" id="togglelog" value="toggle log" style="float: right; margin-top: 5px;" />
</div>
